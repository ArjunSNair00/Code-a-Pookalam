...
Welcome to **Code a Pookalam**! Create your own animated 2D Onam Pookalam using **p5.js** and deploy it live on the web using Vercel—no terminal commands or installation required!
